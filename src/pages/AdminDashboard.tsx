...
import { 
  Building2, CalendarCheck, CalendarClock, History, 
  ChevronLeft, ChevronRight, CalendarPlus, XCircle, 
  RotateCw, UserPlus, CheckCircle2
} from 'lucide-react';

export default function AdminDashboard() {
  // FIX: Ambil data dari Supabase agar konsisten dengan Room Management
            ...
            <div className="p-6 overflow-x-auto">
              <div className="min-w-[600px]">
                <div className="grid grid-cols-6 text-xs font-bold text-slate-400 uppercase tracking-wider mb-4 pb-2 border-b border-slate-100">
                  <div>ROOM</div><div>MON</div><div>TUE</div><div>WED</div><div>THU</div><div>FRI</div>
                </div>
                ...
                <div className="grid grid-cols-6 border-b border-slate-100 py-4 items-center">
                  ...
                  <div><div className="bg-sky-50 border-l-4 border-sky-500 p-2 rounded-r"><p className="text-xs font-bold text-sky-800">Board Meeting</p><p className="text-[10px] text-sky-600">09:00 - 11:30</p></div></div>
                  <div></div>
                  <div><div className="bg-sky-50 border-l-4 border-sky-500 p-2 rounded-r"><p className="text-xs font-bold text-sky-800">Town Hall</p><p className="text-[10px] text-sky-600">14:00 - 16:00</p></div></div>
                  <div></div>
                  <div><div className="bg-slate-50 border-l-4 border-slate-300 p-2 rounded-r"><p className="text-xs font-bold text-slate-600">Maintenance</p><p className="text-[10px] text-slate-400">All Day</p></div></div>
                </div>

                <div className="grid grid-cols-6 border-b border-slate-100 py-4 items-center">
                  <div className="font-semibold text-slate-800">Suite 402</div>
                  <div></div>
                  <div><div className="bg-orange-50 border-l-4 border-orange-500 p-2 rounded-r"><p className="text-xs font-bold text-orange-800">Client Sync</p><p className="text-[10px] text-orange-600">10:00 - 11:00</p></div></div>
                  <div><div className="bg-orange-50 border-l-4 border-orange-500 p-2 rounded-r"><p className="text-xs font-bold text-orange-800">Interview</p><p className="text-[10px] text-orange-600">13:30 - 14:30</p></div></div>
                  <div><div className="bg-orange-50 border-l-4 border-orange-500 p-2 rounded-r"><p className="text-xs font-bold text-orange-800">Review</p><p className="text-[10px] text-orange-600">15:00 - 16:00</p></div></div>
                  <div></div>
                </div>

                <div className="grid grid-cols-6 border-b border-slate-100 py-4 items-center">
                  <div className="font-semibold text-slate-800">Studio B</div>
                  <div><div className="bg-rose-50 border-l-4 border-rose-500 p-2 rounded-r"><p className="text-xs font-bold text-rose-800">Podcast</p><p className="text-[10px] text-rose-600">11:00 - 13:00</p></div></div>
                  <div></div>
                  <div></div>
                  <div><div className="bg-rose-50 border-l-4 border-rose-500 p-2 rounded-r"><p className="text-xs font-bold text-rose-800">Recording</p><p className="text-[10px] text-rose-600">09:00 - 12:00</p></div></div>
                  <div></div>
                </div>
                ...
                <div className="grid grid-cols-6 py-4 items-center">
                  ...
                  <div></div>
                  <div><div className="bg-sky-50 border-l-4 border-sky-500 p-2 rounded-r"><p className="text-xs font-bold text-sky-800">Workshop</p><p className="text-[10px] text-sky-600">14:00 - 17:00</p></div></div>
                  <div></div>
                  <div></div>
                  <div><div className="bg-sky-50 border-l-4 border-sky-500 p-2 rounded-r"><p className="text-xs font-bold text-sky-800">Dev Sprint</p><p className="text-[10px] text-sky-600">10:00 - 12:00</p></div></div>
                </div>
