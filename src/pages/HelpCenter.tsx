...
export default function HelpCenter() {
  // Mengambil nama dari localStorage agar tetap konsisten
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="bg-[#0077B6] rounded-xl p-6 text-white shadow-sm">
            ...
            <div className="space-y-3">
              <button className="w-full bg-white/20 hover:bg-white/30 transition border border-white/30 rounded-lg p-3 flex items-center gap-4 text-left">
                <MessageSquare size={20} className="text-white" />
                <div>
                  <p className="text-[10px] font-bold text-white/70 tracking-wider uppercase">Live Chat</p>
          ...
          {faqs.map((faq, index) => (
            <div key={index} className="group cursor-pointer">
              <div className="flex justify-between items-start mb-2">
                ...
                <ChevronDown size={18} className="text-slate-400 mt-1 flex-shrink-0" />
              </div>
